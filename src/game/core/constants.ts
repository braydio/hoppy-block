...
export const SLIDE_GROUND_LOCK_DURATION = SLIDE_CROUCH_DURATION + SLIDE_DASH_DURATION
...
export const GROUND_ALIGN_EPSILON = 6
export const CAMERA_SHAKE_DECAY = 0.16
export const AIR_CONTROL_HEIGHT_RATIO = 0.45
