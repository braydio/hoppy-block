...
- Achievement, scoreboard, and progression psychology
  - Build a tiered achievement board (daily/weekly/legendary) that links to the new RPG systems:
    “Reach power level 3 before the second checkpoint,” “Upgrade the charge bar three times,” etc. - Improve the scoreboard UI so it highlights streaks, upgrades earned, and achievement badges next to
